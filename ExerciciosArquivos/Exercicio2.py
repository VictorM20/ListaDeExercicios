...
identificar os usuários com maior espaço ocupado. Através de um programa, baixado da Internet,
...
arquivo.write('\nEspaço médio ocupado: %.2f MB' % (espacoTotal / len(usuarios) / (1024.0 * 1024.0)))
arquivo.close()
