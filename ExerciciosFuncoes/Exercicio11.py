...
uma string no formato D de mesPorExtenso de AAAA. Opcionalmente, valide a data e retorne NULL caso a data seja inválida.
"""
...
c = input('Digite uma data por extenso.(DD/MM/AAAA): ')
print(data(c))
